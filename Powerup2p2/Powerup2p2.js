...
export default class Powerup2p2 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./Powerup2p2/costumes/costume1.svg", {
        x: 14,
        y: 14,
      }),
    ];

    this.sounds = [new Sound("Collect", "./Powerup2p2/sounds/Collect.wav")];
